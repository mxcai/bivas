...
For multi-task learning, we use mtExample as demonstration. We set the variables, number of tasks and sample sizes to be $K=1,000$, $l=3$ and $n_1=2,500$, $n_2=3,000$, $n_3=2,500$ respectively.
